"""
EMBEDDING GENERATION - Model 3: qwen3-embedding:8b
===================================================
Generates 4096-dimensional embeddings using CRC Open WebUI API.
...
checkpoint_file = f'{PROJECT_DIR}/checkpoints/progress_qwen3_embedding_8b.json'
partial_file = f'{PROJECT_DIR}/checkpoints/partial_qwen3_embedding_8b.npy'
...
output_file = f'{PROJECT_DIR}/checkpoints/embeddings_qwen3_embedding_8b.npy'
