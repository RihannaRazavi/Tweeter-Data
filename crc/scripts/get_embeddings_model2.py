"""
EMBEDDING GENERATION - Model 2: granite-embedding:278m
======================================================
Generates 768-dimensional embeddings using CRC Open WebUI API.
...
checkpoint_file = f'{PROJECT_DIR}/checkpoints/progress_granite_embedding_278m.json'
partial_file = f'{PROJECT_DIR}/checkpoints/partial_granite_embedding_278m.npy'
...
output_file = f'{PROJECT_DIR}/checkpoints/embeddings_granite_embedding_278m.npy'
